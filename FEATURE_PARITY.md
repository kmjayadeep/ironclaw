...
| GSuite WASM tools | ✅ | 🚧 | Reborn bundles operation-level Google Drive/Docs/Sheets/Slides WASM packages with host-mediated HTTP egress, product-auth scoped bearer injection, and manifest-declared Google OAuth setup metadata whose WebUI Admin values apply live ahead of boot-time environment fallbacks; full live-recorded parity remains follow-up |
