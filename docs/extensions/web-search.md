...
```bash
ironclaw extension install web-search
```
...
```bash
ironclaw extension activate web-search
```

Then supply your API key from **Extensions** in the [web interface](/using/webui). It is stored in the encrypted secret store.
