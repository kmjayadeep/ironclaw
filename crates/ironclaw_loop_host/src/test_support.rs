...
use crate::CheckpointStateStore;
...
/// composition uses.
pub fn in_memory_backed_checkpoint_state_store() -> Arc<CheckpointStateStore<InMemoryBackend>> {
    ...
    Arc::new(CheckpointStateStore::new(Arc::new(
