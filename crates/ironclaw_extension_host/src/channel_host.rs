...
/// Generic lazy-`ProductSurface` glue owned by this crate; composition
/// constructs it and fills it after the runtime's `ProductSurface` exists.
///
...
pub struct SharedCommandSurface {
...
impl SharedCommandSurface {
    ...
    pub fn set(&self, surface: Arc<dyn ironclaw_host_api::ProductSurface>) {
...
pub struct GenericChannelHostDeps {
    ...
    pub command_surface: SharedCommandSurface,
}
