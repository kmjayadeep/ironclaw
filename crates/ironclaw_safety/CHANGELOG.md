...
## [0.2.3](https://github.com/nearai/ironclaw/compare/ironclaw_safety-v0.2.2...ironclaw_safety-v0.2.3) - 2026-07-27

### Added

- *(secrets)* sandbox credential placeholder registry (unwired) ([#6689](https://github.com/nearai/ironclaw/pull/6689))
...
- recoverable errors reach the model, never kill the run — hardened detail channel + fail-soft summary gates ([#5965](https://github.com/nearai/ironclaw/pull/5965))
