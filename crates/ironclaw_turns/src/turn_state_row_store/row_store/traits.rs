...
fn run_gate_matches(kind: ProcessSuspensionKind, status: crate::TurnStatus) -> bool {
    matches!(
        (kind, status),
        (
            ProcessSuspensionKind::Approval,
            crate::TurnStatus::BlockedApproval
        ) | (
            ProcessSuspensionKind::Authorization,
            crate::TurnStatus::BlockedAuth
        ) | (
            ProcessSuspensionKind::Resource,
            crate::TurnStatus::BlockedResource
        ) | (
            ProcessSuspensionKind::AwaitingChildProcess,
            crate::TurnStatus::BlockedDependentRun
        ) | (
            ProcessSuspensionKind::ExternalTool,
            crate::TurnStatus::BlockedExternalTool
        )
    )
}
