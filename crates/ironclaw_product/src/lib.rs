...
pub use ironclaw_host_api::product_adapter::{
    ...
    FinalReplyView, GatePromptView, ImmediateResponse, InboundCommandPayload, InboundOutcome,
    InboundRetryDisposition, LinkedThreadActionPayload, MAX_IMMEDIATE_RESPONSE_BYTES,
