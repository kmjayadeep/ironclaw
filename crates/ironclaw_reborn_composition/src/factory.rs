...
pub(crate) struct RebornRuntimeStores {
    ...
    pub(crate) command_surface: ironclaw_extension_host::channel_host::SharedCommandSurface,
...
async fn build_backend_production(
    ...
    Ok(RebornRuntimeStores {
        ...
        command_surface: ironclaw_extension_host::channel_host::SharedCommandSurface::default(),
